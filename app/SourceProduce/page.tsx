      ...
      <section className="py-8 px-4">
        ...
        {hasLoaded && farmers.length === 0 && (
          <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mt-4 rounded">
            <p className="font-semibold">No farmers match your criteria.</p>
            <p>
              Thank you for your search! Although we couldn’t find any matches
              for your selected crop at the moment, our network is constantly
              expanding. If you have specific requirements, feel free to reach
              out – we’re here to help and will do our utmost to find what you
              need.
            </p>
          </div>
        )}
